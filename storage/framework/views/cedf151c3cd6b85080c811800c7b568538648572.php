                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content collapse show">
						  	...
						  	<form action="<?php echo e(url('/'.Request::segment(1).'/edit/'.$office->id)); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
							...
							<input type="hidden" name="_method" value="PUT">
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="name" class="form-control <?php if($errors->has('name')): ?> is-invalid <?php endif; ?> " value="<?php echo e($office->name); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\workspace\diklat-siaplapor\resources\views/admin/office/edit.blade.php ENDPATH**/ ?>