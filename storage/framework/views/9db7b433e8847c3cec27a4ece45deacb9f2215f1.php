<?php if($paginator->hasPages()): ?>
    <nav>
        <ul class="pagination pagination-sm no-margin pull-right">
            ...
            <?php else: ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo e(\Request::url()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.first'); ?>">First</a>
                </li>
                <li class="page-item">
            ...
            <?php if($paginator->hasMorePages()): ?>
                ...
                <li class="page-item">
                    <a class="page-link" href="<?php echo e(\Request::url().'?page='.$paginator->lastPage()); ?>" rel="last" aria-label="<?php echo app('translator')->get('pagination.last'); ?>">Last</a>
                </li>
            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH E:\workspace\diklat-sipermen\vendor\laravel\framework\src\Illuminate\Pagination/resources/views/bootstrap-4.blade.php ENDPATH**/ ?>