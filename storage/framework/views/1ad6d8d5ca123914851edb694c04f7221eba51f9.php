					...
					<div class="row">
						<div class="col-12 col-xl-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="<?php echo e(url('/'.Request::segment(1).'/edit/'.$klasifikasi->id)); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="kode" class="form-control <?php if($errors->has('kode')): ?> is-invalid <?php endif; ?> " value="<?php echo e($klasifikasi->kode); ?>">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="nama" class="form-control <?php if($errors->has('nama')): ?> is-invalid <?php endif; ?> " value="<?php echo e($klasifikasi->nama); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\workspace\e-nomor\resources\views/admin/klasifikasi/edit.blade.php ENDPATH**/ ?>