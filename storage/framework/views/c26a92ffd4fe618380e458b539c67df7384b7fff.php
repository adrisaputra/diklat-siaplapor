					...
					<div class="row">
						<div class="col-12 col-xl-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="<?php echo e(url('/'.Request::segment(1).'/edit/'.$surat_masuk->id)); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="nomor_surat" class="form-control <?php if($errors->has('nomor_surat')): ?> is-invalid <?php endif; ?> " value="<?php echo e($surat_masuk->nomor_surat); ?>">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<textarea name="perihal" class="form-control <?php if($errors->has('perihal')): ?> is-invalid <?php endif; ?> "><?php echo e($surat_masuk->perihal); ?></textarea>
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="pengirim" class="form-control <?php if($errors->has('pengirim')): ?> is-invalid <?php endif; ?> " value="<?php echo e($surat_masuk->pengirim); ?>">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												...
												<?php if($surat_masuk->arsip_surat_masuk): ?>
													<br>
													<a href="<?php echo e(asset('upload/arsip_surat_masuk/'.$surat_masuk->arsip_surat_masuk)); ?>" target="_blank" class="btn btn-sm btn-primary" >Lihat File</a>
												<?php endif; ?>
											</div>
										</div>
										<br><br>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\workspace\diklat-sipermen\resources\views/admin/surat_masuk/edit.blade.php ENDPATH**/ ?>