...
<body class="vertical-layout vertical-menu-modern 1-column  bg-full-screen-image blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-color="bg-gradient-x-purple-red" data-col="1-column" style="background-image: url(app-assets/images/backgrounds/bg-18.jpg);background-size: cover;">
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo e(asset('app-assets/js/scripts/forms/form-login-register.js')); ?>" type="text/javascript"></script>
    <!-- END: Page JS-->

</body>
<!-- END: Body-->

</html><?php /**PATH E:\workspace\diklat-siaplapor\resources\views/layouts/app.blade.php ENDPATH**/ ?>