        ...
        <div class="card-body">
            <div class="m-sm-4">
                <div class="text-center">
                    <img src="<?php echo e(asset('/upload/logo/logo.png')); ?>"class="img-fluid" style="max-width: 100%;height:120px">
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\workspace\e-nomor\resources\views/auth/login.blade.php ENDPATH**/ ?>