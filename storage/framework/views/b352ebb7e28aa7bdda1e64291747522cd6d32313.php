                            ...
                            <div class="card-content collapse show">
						  	...
						  	<form action="<?php echo e(url('/'.Request::segment(1))); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="select2 form-control <?php if($errors->has('type')): ?> is-invalid <?php endif; ?> " id="default-select" name="type">
                                            ...
                                            <option value="Draft SK" <?php if(old('type')=="Draft SK"): ?> selected <?php endif; ?>>Draft SK</option>
                                            <option value="Pergub" <?php if(old('type')=="Pergub"): ?> selected <?php endif; ?>>Pergub</option>
                                            <option value="Perda" <?php if(old('type')=="Perda"): ?> selected <?php endif; ?>>Perda</option>
                                            <option value="MOU" <?php if(old('type')=="MOU"): ?> selected <?php endif; ?>>MOU</option>
                                            <option value="NPHD" <?php if(old('type')=="NPHD"): ?> selected <?php endif; ?>>NPHD</option>
                                            <option value="Nota Kesepahaman" <?php if(old('type')=="Nota Kesepahaman"): ?> selected <?php endif; ?>>Nota Kesepahaman</option>
                                            <option value="Surat Edaran Gubernur" <?php if(old('type')=="Surat Edaran Gubernur"): ?> selected <?php endif; ?>>Surat Edaran Gubernur</option>
                                            <option value="Instruksi Gubernur" <?php if(old('type')=="Instruksi Gubernur"): ?> selected <?php endif; ?>>Instruksi Gubernur</option>
                                            <option value="Lainnya" <?php if(old('type')=="Lainnya"): ?> selected <?php endif; ?>>Lainnya</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control <?php if($errors->has('about')): ?> is-invalid <?php endif; ?> " name="about" id="basicTextarea" rows="3"></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="responsible_person" class="form-control <?php if($errors->has('responsible_person')): ?> is-invalid <?php endif; ?> " value="<?php echo e(old('responsible_person')); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="whatsapp" class="form-control <?php if($errors->has('whatsapp')): ?> is-invalid <?php endif; ?> " value="<?php echo e(old('whatsapp')); ?>">
