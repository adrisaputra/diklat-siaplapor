...
<head>
	...
	<title>E-Nomor Imigrasi Kendari</title>

    <link rel="preconnect" href="//fonts.gstatic.com/" crossorigin="">
    
    <!-- Favicons -->
    <link href="<?php echo e(asset('/upload/logo/imigrasi.png')); ?>" rel="icon">
    <link href="<?php echo e(asset('/upload/logo/imigrasi.png')); ?>" rel="apple-touch-icon">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?php echo e((request()->is('surat_masuk*')) ? 'active' : ''); ?>">
						<a href="<?php echo e(url('/surat_masuk')); ?>" class="sidebar-link">
						  <i class="align-middle" data-feather="users"></i> <span>Surat Masuk</span>
						</a>
					</li>
					<li class="sidebar-item <?php echo e((request()->is('surat_keluar*')) ? 'active' : ''); ?>">
						<a href="<?php echo e(url('/surat_keluar')); ?>" class="sidebar-link">
						  <i class="align-middle" data-feather="users"></i> <span>Surat Keluar</span>
						</a>
					</li>
					...
					<li class="sidebar-item <?php echo e((request()->is('klasifikasi*')) ? 'active' : ''); ?>">
						<a href="<?php echo e(url('/klasifikasi')); ?>" class="sidebar-link">
						  <i class="align-middle" data-feather="list"></i> <span>Klasifikasi</span>
						</a>
					</li>
...
<?php /**PATH E:\workspace\e-nomor\resources\views/admin/layout.blade.php ENDPATH**/ ?>