                        ...
                        <div class="card">
                            <div class="card-content collapse show">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">Ubah <?php echo e(__($title)); ?></h4>
                                </div>
						  	<form action="<?php echo e(url('/'.Request::segment(1).'/edit/'.$agenda->id)); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="date" name="date_of_entry" class="form-control <?php if($errors->has('date_of_entry')): ?> is-invalid <?php endif; ?> " value="<?php echo e($agenda->date_of_entry); ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="date" name="letter_date" class="form-control <?php if($errors->has('letter_date')): ?> is-invalid <?php endif; ?> " value="<?php echo e($agenda->letter_date); ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="letter_number" class="form-control <?php if($errors->has('letter_number')): ?> is-invalid <?php endif; ?> " value="<?php echo e($agenda->letter_number); ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="letter_from" class="form-control <?php if($errors->has('letter_from')): ?> is-invalid <?php endif; ?> " value="<?php echo e($agenda->letter_from); ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="about" class="form-control <?php if($errors->has('about')): ?> is-invalid <?php endif; ?> " value="<?php echo e($agenda->about); ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="on_process" class="form-control <?php if($errors->has('on_process')): ?> is-invalid <?php endif; ?> " value="<?php echo e($agenda->on_process); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\workspace\diklat-siaplapor\resources\views/admin/agenda/edit.blade.php ENDPATH**/ ?>