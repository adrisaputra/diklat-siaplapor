					...
					<div class="row">
						<div class="col-12 col-xl-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="{{ url('/'.Request::segment(1).'/edit/'.$klasifikasi->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
									{{ csrf_field() }}
									<input type="hidden" name="_method" value="PUT">
									<div class="form-group row">
											<label class="col-form-label col-sm-3 text-sm-right"> Kode <span class="required" style="color: #dd4b39;">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="kode" class="form-control @if ($errors->has('kode')) is-invalid @endif " value="{{ $klasifikasi->kode }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="nama" class="form-control @if ($errors->has('nama')) is-invalid @endif " value="{{ $klasifikasi->nama }}">
