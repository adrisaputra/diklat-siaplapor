                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content collapse show">
						  	...
						  	<form action="{{ url('/'.Request::segment(1).'/edit/'.$agenda->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
							{{ csrf_field() }}
                            ...
                            <div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="date" name="date_of_entry" class="form-control @if ($errors->has('date_of_entry')) is-invalid @endif " value="{{ $agenda->date_of_entry }}">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="date" name="letter_date" class="form-control @if ($errors->has('letter_date')) is-invalid @endif " value="{{ $agenda->letter_date }}">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="letter_number" class="form-control @if ($errors->has('letter_number')) is-invalid @endif " value="{{ $agenda->letter_number }}">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="letter_from" class="form-control @if ($errors->has('letter_from')) is-invalid @endif " value="{{ $agenda->letter_from }}">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="about" class="form-control @if ($errors->has('about')) is-invalid @endif " value="{{ $agenda->about }}">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="on_process" class="form-control @if ($errors->has('on_process')) is-invalid @endif " value="{{ $agenda->on_process }}">
