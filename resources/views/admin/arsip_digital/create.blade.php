						...
						<div class="col-12 col-xl-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<form action="{{ url('/'.Request::segment(1).'/'.$pegawai[0]->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
									{{ csrf_field() }}
										<div class="form-group row">
											<label class="col-form-label col-sm-3 text-sm-right"> Nama Arsip <span class="required" style="color: #dd4b39;">*</span></label>
											<div class="col-sm-9">
												<input type="text" name="nama_arsip" class="form-control @if ($errors->has('nama_arsip')) is-invalid @endif " value="{{ old('nama_arsip') }}">
